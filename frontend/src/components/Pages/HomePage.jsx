          ...
          <Col xs={12} md={8}>
            ...
            <Card style={{ marginTop: '10px' }}>
              <CardBody>
                ...
                in DoC. Each family will consist of two parents and up to five freshers.
                This year, due to the unusual circumstances, family activities 
                in the Autumn term will be held remotely. There will be a range of
                opportunities for you to bond with your family, starting with a virtual pub quiz.
                Each term there is also a small budget for each family (around 20 pounds) to use as appropriate.
                </CardText>
                <CardTitle>
